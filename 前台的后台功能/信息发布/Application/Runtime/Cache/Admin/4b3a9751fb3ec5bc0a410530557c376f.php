						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body" style="overflow-y:auto;height:400px;" id="detail">
                                    ...
                                    <p>车主电话：<span></span></p>
                                    <p>证件号码：<span></span></p>
                                    <p>证件照片：<span><img src="/easygo/5.15_5.21/easygo/Public/Admin/images/idcard.gif" width="290" height="180" /></span></p>
                                    <p>车辆信息：<span></span></p>
                                    <p>车主描述：<span></span></p>
                                    <p>车辆照片：<span></span></p>
								</div>
		...
		function postIt (res){	
			...
			function(data,status){	
				...
				console.log(array);
					...
					$('#detail p span').eq(3).text(array['user_idphoto']);
					...
					//跳转修改状态方法
					$("#pass").attr("href","/easygo/5.15_5.21/easygo/index.php/Admin/Cars/pass/inf_id/"+array['inf_id']);
					$("#notPass").attr("href","/easygo/5.15_5.21/easygo/index.php/Admin/Cars/notPass/inf_id/"+array['inf_id']);
					return false;				
			});
