	...
	function postIt (res){	
			...
			function(data,status){	
				...
				for (var i = array.length - 1; i >= 0; i--) {
					$("#detail").append("<p class='p2 p4'><img src='/easygo/5.15_5.21/easygo/Public/Admin/images/img1.jpg' width='160' height='100'><span class='p44'>"+array[i]['inf_type']+"</span><span>"+array[i]['inf_carnumber']+"</span>"+array[i]['inf_province']+"/"+array[i]['inf_city']+"</p>");
				};
