	...
	function postIt (res){	
			...
			function(data,status){	
				...
				console.log(array);
					...
					$("#pass").attr("href","/easygo/5.15_5.21/easygo/index.php/Admin/User/pass/user_id/"+array['user_id']);
					$("#notPass").attr("href","/easygo/5.15_5.21/easygo/index.php/Admin/User/notPass/user_id/"+array['user_id']);
					return false;				
			});
