...
<link href="/easygo/Public/Home/css/lend.css" rel="stylesheet" type="text/css" />
</head>
	...
	<div class="mybody">
       		<div class="order">
                ...
                <div class="detail">
                    ...
                    <p style="border-top:1px solid #e3e4e6;">订单号：0000000001&nbsp;&nbsp;租车人：刘二狗&nbsp;&nbsp;租期：30天&nbsp;&nbsp;车主：刘大壮&nbsp;&nbsp;车主联系方式：13088888888</p>
                </div>
                <table cellspacing="0">
                	<tr>
                    ...
                    <tr>
                    	<td style="height:118px;">
                        	<img src="/easygo/Public/Home/images/order.jpg" width="160" height="100" alt="" />  
                        </td>
                        <td>
                        	<h5>雪佛兰科鲁兹</h5>
                            <p class="p">三厢/自动挡/乘坐5人</p>
                            <p class="p">订单号：0000000001</p></td>
                        <td>
                        	<p>2017-05-05</p>
                            <p>至</p>
                            <p>2017-05-05</p>
                ...
                <div class="cost">
                	<h1>费用明细</h1>
                    <p>车辆租赁费用<span>+198*30=<span>￥5940</span></span></p>
                    <p>押金<span>-3000*1=<span>￥3000</span></span></p>
                    <p>手续费<span>+98*1=<span>￥98</span></span></p>
                    <p data-toggle="modal" data-target="#mymodal-data"><input type="checkbox" />&nbsp;保险费<span>+50*30=<span>￥1500</span></span></p>
                    <p data-toggle="modal" data-target="#mymodal-data1"><input type="checkbox" />&nbsp;优惠券<span>-100*1=<span>￥100</span></span></p>
                    <p><span>合计：<span>￥10438</span></span></p>
								...
								<div class="modal-body" style="overflow-y:auto;height:340px;">
									...
									<table>
                                    	<tr>
                                            ...
                                            <td><img src="/easygo/Public/Home/images/yhq.jpg" /><p>有效期：2017.05.05-2017.10.05</p></td>
                                        </tr>
                                        <tr>
                                        	<td><label><input name="yhq1" type="radio" value="" /></label></td>
                                            <td><img src="/easygo/Public/Home/images/yhq.jpg" /><p>有效期：2017.05.05-2017.10.05</p></td>
...
<script src="/easygo/Public/Home/js/bootstrap.min.js"></script>
