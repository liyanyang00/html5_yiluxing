       ...
       <div class="right">
       		<div class="order yhk">
                ...
                <table cellspacing="0" style="text-align:center;">
                	<tr>
                    	<td width="300px">
                        	<a href="<?php echo U('Indent/cardInform');?>"><img src="/easygo/Public/Home/images/yhk.jpg" width="265" height="166" /></a>
                        </td>
                        <td width="300px">
                        	<a href="<?php echo U('Indent/addCard');?>"><img src="/easygo/Public/Home/images/addyhk.jpg" width="265" height="166" /></a>
                        </td>
                        <td></td>
                    </tr>
