...
<link href="/easygo/Public/Home/css/index.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="/easygo/Public/Home/css/normalize.css" />
<link rel="stylesheet" type="text/css" href="/easygo/Public/Home/css/demo.css" />

<!--必要样式-->
<link rel="stylesheet" type="text/css" href="/easygo/Public/Home/css/set1.css" />
<style type="text/css">
    #xu{
        width:104px; 
    }
        ...
        <div class="picshow">
            <div class="pic grid grid1" style="margin:-7px 0 0 0px;">
                <figure class="pic1 effect-roxy" style="width:839px;height:485px;">
                	<img src="/easygo/Public/Home/images/pic01.jpg" width="839" height="485" />
                    <figcaption>
            ...
            <div class="pic picc grid" style="margin:-7px 0 0 20px;">
                <figure class="pic1 effect-sadie">
                	<img src="/easygo/Public/Home/images/pic02.jpg" width="341" height="485" />
                    <figcaption>
...
我们只租放心的车。</p>
            ...
            <div class="pic grid" style="margin:-7px 0 0 5px;">
                <figure class="pic1 effect-sadie">
                	<img src="/easygo/Public/Home/images/pic03.jpg" width="341" height="485" />
                    <figcaption>
					<div>
...
成您一个月的油费。</p>
            ...
            <div class="pic picc grid grid1" style="margin:-7px 0 0 -10px;">
                <figure class="pic1 effect-bubba" style="width:839px;height:485px;">
                	<img src="/easygo/Public/Home/images/pic04.jpg" width="839" height="485" />
                    <figcaption>
        ...
        <div class="today">
            ...
            <div>
                <div class="car" alt="1">
                    <a href="#"><img src="/easygo/Public/Home/images/photo.png" width="280" height="160" /></a>
                    <p>￥&nbsp;<span>198</span>&nbsp;/天</p>
                    <h3><a href="#">大众斯柯达明锐</a><span>河北·石家庄</span></h3>
                    <h4><a href="#">操控&nbsp;自动&nbsp;|&nbsp;舒适型&nbsp;|&nbsp;5座</a></h4>
                </div>
                <div class="car car1" alt="1">
                    <a href="#"><img src="/easygo/Public/Home/images/photo.png" width="280" height="160" /></a>
                    <p>￥&nbsp;<span>198</span>&nbsp;/天</p>
                    <h3><a href="#">大众斯柯达明锐</a><span>河北·石家庄</span></h3>
                    <h4><a href="#">操控&nbsp;自动&nbsp;|&nbsp;舒适型&nbsp;|&nbsp;5座</a></h4>
                ...
                <div class="car car1" alt="1">
                    <a href="#"><img src="/easygo/Public/Home/images/today.jpg" width="280" height="160" /></a>
                    <p>￥&nbsp;<span>198</span>&nbsp;/天</p>
                    <h3><a href="#">大众斯柯达明锐</a><span>河北·石家庄</span></h3>
                    <h4><a href="#">操控&nbsp;自动&nbsp;|&nbsp;舒适型&nbsp;|&nbsp;5座</a></h4>
                </div>
                <div class="car car1" alt="2">
                    <a href="#"><img src="/easygo/Public/Home/images/today.jpg" width="280" height="160" /></a>
                    <p>￥&nbsp;<span>198</span>&nbsp;/天</p>
                    <h3><a href="#">大众斯柯达明锐</a><span>河北·石家庄</span></h3>
                    <h4><a href="#">操控&nbsp;自动&nbsp;|&nbsp;舒适型&nbsp;|&nbsp;5座</a></h4>
...
<div class="content1">
	<div class="mybody">
    	<div class="lend">
        	<h1>短租自驾</h1>
            <img src="/easygo/Public/Home/images/car1.jpg" width="200" height="130" />
            <p>一键约车，轻松取还</p>
            <a href="<?php echo U('Rent/index');?>" class="button">我要约车</a>
        </div>
        <div class="lend lend1">
        	<h1>长期租用</h1>
            <img src="/easygo/Public/Home/images/car2.jpg" width="200" height="130" />
            <p>长期租借，更多优惠</p>
            <a href="<?php echo U('Rent/index');?>" class="button">我要约车</a>
        </div>
        <div class="lend lend1">
        	<h1>闲置出租</h1>
            <img src="/easygo/Public/Home/images/car3.jpg" width="200" height="130" />
            <p>自家闲置，随时出租</p>
            <a href="<?php echo U('Issue/index');?>" class="button">我要分享</a>
        </div>
        <div class="lend lend1">
        	<h1>租车公司</h1>
            <img src="/easygo/Public/Home/images/car4.jpg" width="200" height="130" />
            <p>更多客源，更多展示</p>
            <a href="<?php echo U('Issue/index');?>" class="button">我要分享</a>
        </div>
    </div>  
