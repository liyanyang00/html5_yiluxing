...
<div class="content">
	<div class="mybody">
       <div class="bread">
       		<p>当前位置：<a href="<?php echo U('Index/index');?>">易路行</a> > <a href="添加座驾1.html">添加座驾</a> - <a href="添加座驾4.html">信息审核</a></p>
       </div>
       <div class="add_bg">
       ...
       <div class="left left2">
            ...
            <form>
            	<tr>
                	<th class="title" style="height:100px;">您的车辆信息已登记，请耐心等待审核通过！</th>
                </tr>
                
                <tr>
                	<th colspan="3"><a href="<?php echo U('Indent/myCars');?>" target="_blank">查看我的座驾</a></td>
                </tr>
            </form>
            </table>
       </div>
