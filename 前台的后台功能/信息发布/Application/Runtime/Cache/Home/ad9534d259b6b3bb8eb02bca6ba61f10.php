...
<!-- <link href="/easygo/Public/Home/css/common.css" rel="stylesheet" type="text/css" /> -->
<link href="/easygo/Public/Home/css/index3.css" rel="stylesheet" type="text/css" />
...
<div class="content">
	<div class="mybody">
       ...
       <div class="left left2">
       		<table>
            <form method="post" action="/easygo/index.php/Home/Issue/upload" enctype="multipart/form-data">
                ...
                <tr>
                	<td style="height:240px;">
                            <!-- <div class="img" style="margin-bottom:10px">
                                <div class="file-box"> 
                                     <img src="/easygo/Public/Home/images/add_card.jpg" width="360" height="210" />
                    ...
                    <div class="z_photo upimg-div clear" >               
                         <section class="z_file fl">
                            <img src="/easygo/Public/Home/images/add_card.jpg" width="360" height="210" class="add-img">
