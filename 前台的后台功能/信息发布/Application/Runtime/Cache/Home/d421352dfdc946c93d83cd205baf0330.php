...
<link type="text/css" rel="Stylesheet" href="/easygo/Public/Home/css/imageflow.css" />
<script type="text/javascript" src="/easygo/Public/Home/js/imageflow.js"></script>
	...
	<div class="mybody2">
       ...
       <p>每日推出特价优惠车辆，尽享超低折扣价！</p>
        ...
        <div id="starsIF" class="imageflow"> 
            <img src="/easygo/Public/Home/images/hd1.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd2.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd3.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd4.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd5.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd6.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
            <img src="/easygo/Public/Home/images/hd7.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" />  
            <img src="/easygo/Public/Home/images/hd8.jpg" longdesc="<?php echo U('Rent/detail');?>" width="680" height="300" alt="Picture" /> 
        </div>
</div>
		...
		<div class="today">
            ...
            <div>
                <div class="car">
                    <a href="<?php echo U('Rent/detail');?>"><img src="/easygo/Public/Home/images/today.jpg" width="280" height="160" /></a>
