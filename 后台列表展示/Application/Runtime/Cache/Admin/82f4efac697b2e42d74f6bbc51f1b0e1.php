    ...
    <div class="row content">
        ...
        <div class="col-md-10 col-xs-10 right">
            ...
            <div class="buttongroup">
                <form method="post" action="/easygo/index.php/Admin/Admin/doAdd" class="form1">
                	登陆账号：
                    <input type="text" value="" name="adm_username"><br />
                    真实姓名：
                    <input type="text" value="" name="adm_name"><br />
                    电子邮箱：
                    <input type="text" value="" name="adm_email"><br />
                    联系电话：
                    <input type="text" value="" name="adm_phone"><br />
                    添加时间：
                    <input type="text" name="adm_addtime" id="today" readonly><br />
                    设置密码：
                    <input type="password" value="" name="adm_password"><br />
                    确认密码：
                    <input type="password" value="" name="adm_password"><br />
                    <button type="submit" class="button1 button11">添加</a>
