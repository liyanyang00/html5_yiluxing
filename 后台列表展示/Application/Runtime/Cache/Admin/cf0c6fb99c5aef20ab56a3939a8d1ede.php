        ...
        <div class="col-md-10 col-xs-10 right">
            ...
            <div class="buttongroup">
                <form action="">
                    ...
                    <button type="submit" href="#" class="button1">查询</button>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body" style="overflow-y:auto;height:400px;">
                                    ...
                                    <p>车辆信息：<span>车牌号：冀A12345&nbsp;&nbsp;品牌车型：奇瑞QQ2012&nbsp;&nbsp;颜色：白<br />&nbsp;变速箱：手动挡&nbsp;&nbsp;座位数：5座&nbsp;&nbsp;燃料类型：汽油&nbsp;&nbsp;天窗：单天窗<br />&nbsp;音箱：有&nbsp;&nbsp;真皮座椅：有&nbsp;&nbsp;倒车雷达：有<br />&nbsp;GPS导航：有&nbsp;&nbsp;可抽烟：否</span></p>
                                    <p>车辆原价：<span>￥198元/天</span></p>
                                    <p>活动组价：<span>￥98元/天</span></p>
								...
								<div class="modal-footer">
									<button type="button" data-dismiss="modal" class="button1 button3" style="margin-right:20px;">删除此车</button>
