...
class IssueController extends Controller {
    ...
    public function add(){	
        if(IS_POST){    
            ...
            $condition = array(    
                'inf_user_id' => $_SESSION['id'],
                'inf_type' =>  I("post.provincee"),
                'inf_cartype' => I("post.cityy"),
            ...
            if($result){ 
            	$userId = $_SESSION['id'];
            	$judge = M('usertab')->where('user_id='.$userId)->find();
            	if($judge['user_state'] == "已实名"){	
            		$this->redirect("Home/Issue/perfectInf/inf_id/{$inf_id}");
            	}
            	else{	
    ...
    public function addDetail(){	
        if(IS_POST){    
            ...
            $condition = array(               
                ...
                'inf_fueltype' => I("post.province"),
                'inf_fuelnum' => I("post.city"),
                'inf_drivemanner' => I("post.drive")
                );
