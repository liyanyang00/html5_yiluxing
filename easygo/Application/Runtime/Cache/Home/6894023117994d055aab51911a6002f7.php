...
<div class="content">
	<div class="mybody">
       <div class="left">
       		<div class="person">
            	<div class="person_head">
                    ...
                    <div class="left_1">
                    	...
                    	<h4><span><?php echo ($count2); ?></span>单</h4>
                        <h4>未完成订单</h4></a>
                    </div>
                    <div class="left_2">
            ...
            <div class="left_nav">
            	<h1>我的订单</h1>
                <a href="<?php echo U('Indent/rentItem');?>">租车订单(<?php echo ($count1); ?>)</a>
                <a href="<?php echo U('Indent/shareItem');?>" class="person_now">出租订单(<?php echo ($count); ?>)</a>
                <h1>我的资产</h1>
       ...
       <div class="right">
       		<div class="order">
            	<h1>出租订单</h1>
                <form method="get" action="/easygo/easygo/index.php/Home/Indent/queryshare">
                ...
                <table cellspacing="0">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><volist name="data" id="e">
                    <?php
 $a = $e['inf_carphoto']; $arr = explode(",",$a); ?>
                        ...
                        <td>
                            ...
                            <p><a href="<?php echo U('Indent/shareDetail');?>/ind_id/<?php echo ($e["ind_id"]); ?>">查看</a></p>
                        </td>
