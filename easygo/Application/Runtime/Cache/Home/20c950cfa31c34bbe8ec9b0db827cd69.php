...
<link href="/easygo/easygo/Public/Home/css/index4.css" rel="stylesheet" type="text/css" />
...
<div class="content">
	<div class="mybody">
       ...
       <div class="left">
       		<table>
            <form method="post" action="/easygo/easygo/index.php/Home/Issue/addDetail" enctype="multipart/form-data" name="form1">
                ...
                <tr>
                    ...
                    <td colspan="3" rowspan="3">
                        <!-- <div class="img" style="margin-bottom:10px">
                                <div class="file-box"> 
                                     <img src="/easygo/easygo/Public/Home/images/img_add.jpg" class="img" width="205" height="120" />
                        ...
                        <div class="z_photo upimg-div clear" >               
                         <section class="z_file fl">
                            <img src="/easygo/easygo/Public/Home/images/add_card.jpg" width="205" height="120" class="add-img">
...
<script type="text/javascript" src="/easygo/easygo/Public/Home/js/oil.js"></script>
<script>
