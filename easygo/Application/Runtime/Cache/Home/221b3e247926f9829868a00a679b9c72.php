    ...
    <div class="mybody">
       <div class="left">
            ...
            <div class="left_nav">
                ...
                <a href="<?php echo U('Indent/alterPwd');?>" class="person_now">修改密码</a>
       ...
       <div class="right">
            <div class="order yhk addyhk">
                <h1>修改密码</h1>
                <table cellspacing="0">
                <form action="/easygo/easygo/index.php/Home/Indent/doAlert" method="post">
                    <tr>
                        <td width="100px" style="text-align:right">
                            旧密码：
                        </td>
                        <td width="200px">
                            <input type="password" name="earlypwd"/>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="password" name="latepwd"/>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                ...
                <div class="cartoon">
                    <img src="/easygo/easygo/Public/Home/images/xgmm.jpg" />
                </div>
            </div>
