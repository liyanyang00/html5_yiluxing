    ...
    <div class="mybody">
       <div class="left">
            ...
            <div class="left_nav">
                ...
                <h1>我的会员</h1>
                <a href="<?php echo U('Indent/vipLevel');?> class="person_now"">会员等级</a>
       ...
       <div class="right">
            <div class="vip">
                <h1>会员等级&nbsp;<span>(<?php echo ($data['user_cost']); ?>/10000)</span></h1>
                <div class="write1">
                    <div class="am-progress">
                    <?php
 $a = $data['user_cost']/100; ?>
                        <div class="am-progress-bar am-progress-bar-warning" style="width:<?php echo ($a); ?>%"></div>
                    </div>
                    <div class="point point1">
                        <div class="pointt">
                            <div class="pointtt"></div>
                        </div>
                    </div>
                    ...
                    <h2 style="margin-top:0;">会员分级</h2>
                    <p>易路行租车会员级别分为5个等级，分别为：普通卡、银卡会员、金卡会员、白金会员、钻石会员。会员级别的调整均由易路行租车根据用户消
费情况累积自动处理，无需会员申请。</p>
                    <p>会员级别由累计消费总额决定，累计消费越高会员等级越高，享受到的会员权益越大。</p>
                  <h2>会员级别规则如下：</h2>
