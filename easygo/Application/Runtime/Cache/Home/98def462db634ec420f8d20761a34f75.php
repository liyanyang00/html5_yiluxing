...
<div class="content" >
	<div class="mybody">
       ...
       <div class="right"  name="data">
       		<div class="order">
            	<h1>订单详情</h1>
                <div class="detail">
                	<?php
 if($data['ind_pay'] == "否"){ echo "<p><span class='detail1'>付款中</span>&nbsp;&nbsp;<span class='detail2'>订单总价：</span><span class='detail3'>￥</span><span class='detail4'>".$data['ind_currentprice']."</span></p>"; } else{ echo "<p><span class='detail1'>已付款</span></p>"; } ?>
                	
                    <p style="border-top:1px solid #e3e4e6;">订单号：<?php echo ($data["ind_id"]); ?>&nbsp;&nbsp;租车人：<?php echo ($user['user_name']); ?>&nbsp;&nbsp;租期：<?php echo ($data["ind_day"]); ?>天&nbsp;&nbsp;车主：<?php
 $where = 'user_id='.$data["inf_user_id"]; $owner = M('usertab')->where($where)->find(); echo $owner['user_name']; ?>&nbsp;&nbsp;车主联系方式：<?php echo ($data["inf_telephone"]); ?></p>
                </div>
                <table cellspacing="0">
                	<tr>
 ...
 $a = $data['inf_carphoto']; $arr = explode(",",$a); ?>
                        ...
                        <td>
                            ...
                            <p class="p"><?php echo ($data["inf_type"]); ?>/乘坐<?php echo ($data["inf_chair"]); ?>人</p>
                        ...
                        <td><h4>￥<?php echo ($data["ind_currentprice"]); ?>元</h4></td>
                    </tr>
                </table>
                <div class="cost">
                	<h1>费用明细</h1>
                    <p>车辆租赁费用<span>+198*30=<span>￥<?php echo ($data["ind_originalprice"]); ?></span></span></p>
                    <?php
 $insurance = $data['ind_insurance']; $price = $data['ind_originalprice']+$insurance-100; ?>
                    <p>保险费<span>+<?php echo ($data['ind_originalprice']); ?>*0.05=<span>￥<?php echo ($insurance); ?></span></span></p>
                    <p>优惠券<span>-100*1=<span>￥100</span></span></p>
                    <p><span>合计：<span>￥<?php echo ($price); ?></span></span></p>
                    <?php
 if($data['ind_pay'] == "否"){ echo "<a href='".U('Indent/createItem')."/ind_id/".$data['ind_id']."' class='pay'>付款</a>"; } else{ echo "<a href='/easygo/easygo/index.php/Home/Indent/returnback/ind_id/".$data['ind_id']."' class='pay'>还车</a>"; } ?>
