...
<div class="content">
            ...
            <div class="order">
                ...
                <table cellspacing="0">
                    <tr>
                        ...
                        <th style="width:200px;">车辆状态</th>
                        <th style="width:200px;">借还时间</th>
                        <th style="width:200px;">租车价格</th>
                    </tr>
 ...
 $a = $data['inf_carphoto']; $arr = explode(",",$a); ?>
                        ...
                        <td>
                            ...
                            <p class="p"><?php echo ($data["inf_introduce"]); ?></p>
                        <td>
                            <p><?php echo ($data["inf_carstate"]); ?></p>
                        </td>
                        <td>
                        ...
                        <td><p>￥<?php echo ($data["inf_dayprice"]); ?>元/天</p>
                        <p>￥<?php echo ($data["inf_weekprice"]); ?>元/周</p>
                        <p>￥<?php echo ($data["inf_monthprice"]); ?>元/月</p></td>
                </table>
                <div class="configure">
                    <h1>配置信息</h1>
                    ...
                    <p><img src="/easygo/easygo/Public/Home/images/bs.gif" width="20" height="20" alt="" />变速箱类型：<span><?php echo ($data["inf_gearbox"]); ?></span></p>
                ...
                <div class="change">
                    <p>修改价格：</p>
                    <form action="/easygo/easygo/index.php/Home/Indent/change" method="post"> 
                    <input type="text" name="inf_id" value="<?php echo ($_GET['inf_id']); ?>" style="display:none"/>
                        日租价：<input type="text" name="day" placeholder="" />&nbsp;元/日<br />
                        月租价：<input type="text" name="week" placeholder="" />&nbsp;元/周<br />
                        年租价：<input type="text" name="month" placeholder="" />&nbsp;元/月<br />
