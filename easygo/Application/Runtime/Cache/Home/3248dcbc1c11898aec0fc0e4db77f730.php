...
<div class="content">
	<div class="mybody2">
		...
		<div class="middle-top">
			<form method="" action="/easygo/easygo/index.php/Home/Rent/search" name="infor">
				您的位置：<input type="text" name="address"/>
				取车时间：<input id="time" type="date" name="date1" value="<?php echo ($infor["date1"]); ?>" />
				还车时间：<input id="time" type="date" name="date2" value="<?php echo ($infor["enddate"]); ?>"/>
		...
		<div class="tao">
			...
			<?php if(is_array($infor)): $i = 0; $__LIST__ = $infor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$e): $mod = ($i % 2 );++$i;?><tr>
					<td style="width:160px;"><a href="<?php echo U('Rent/detail');?>" target="_blank"><img src="<?php echo ($e["inf_carphoto"]); ?>" width="150" height="92"></a></td>
					<td style="width:290px;">
						<a href="<?php echo U('Rent/detail');?>" target="_blank"><p class="QQ"><?php echo ($e["inf_type"]); ?>&nbsp;&nbsp;<?php echo ($e["inf_register"]); ?></p>
						<p class="qq"><?php echo ($e_inf_introduce); ?> <?php echo ($e["inf_displayment"]); ?> <?php echo ($e["inf_gearbox"]); ?> </p>
					...
					<td style="width:130px;">
						<a href="<?php echo U('Rent/detail');?>/id/<?php echo ($e["inf_id"]); ?>" target="_blank" class="go">我要租</a>
					</td>
