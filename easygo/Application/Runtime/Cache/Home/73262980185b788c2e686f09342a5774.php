...
<div class="content">
	<div class="mybody">
       ...
       <div class="left">
       		<table>
            <form method="post" action="/easygo/easygo/index.php/Home/Issue/add" name="form1">               
            	<tr>
            ...
            <SELECT NAME="city" class="sheng" style="margin-left:10px;">    
                ...
                <tr>
                    <th>品牌车型</th>
                    <td>
                        <select name="provincee" onChange="set_cityy(this, this.form.cityy);" class="sheng">
                        <option value="0">请选择品牌</option>
                        <option value="奥迪">奥迪</option>
                        <option value="奥克斯">奥克斯</option>
                        <option value="阿尔法·罗米欧">阿尔法·罗米欧</option>
                        <option value="阿斯顿·马丁">阿斯顿·马丁</option>
                        <option value="奔驰">奔驰</option>
                        <option value="宝马">宝马</option>
                        <option value="标致">标致</option>
                        <option value="北汽制造">北汽制造</option>
                        <option value="比亚迪">比亚迪</option>
                        <option value="本田">本田</option>
                        <option value="奔腾">奔腾</option>
                        <option value="宝龙">宝龙</option>
                        <option value="保时捷">保时捷</option>
                        <option value="宾利">宾利</option>
                        <option value="别克">别克</option>
                        <option value="布嘉迪">布嘉迪</option>
                        <option value="宝骏">宝骏</option>
                        <option value="北汽威旺">北汽威旺</option>
                        <option value="巴博斯">巴博斯</option>
                        <option value="长城">长城</option>
                        <option value="昌河">昌河</option>
                        <option value="长丰">长丰</option>
                        <option value="大众">大众</option>
                        <option value="东风">东风</option>
                        <option value="东南">东南</option>
                        </select>
                        <select   name="cityy" id="citys" style="margin-left:10px;" class="sheng">
...
<script type="text/javascript" src="/easygo/easygo/Public/Home/js/city.js"></script>
<script type="text/javascript" src="/easygo/easygo/Public/Home/js/car.js"></script>
