...
<title>易路行</title>
<link href="/easygo2/easygo/Public/Home/css/public.css" rel="stylesheet" type="text/css" />
<link href="/easygo2/easygo/Public/Home/css/person.css" rel="stylesheet" type="text/css" />
	...
	<div class="mybody">
    	<div class="logo"><a href="<?php echo U('Rent/index');?>"><img src="/easygo2/easygo/Public/Home/images/logo.jpg" alt="logo" /></a></div>
			...
			<div class="top-right2">
				<div>
					<ul>
                        <li><p>您好！&nbsp;<?php echo ($user['user_name']); ?>&nbsp;&nbsp;&nbsp;<img src="/easygo2/easygo/Public/Home/images/down.gif" alt="" /></p>
                            <div id="children">
                                <div class="arrow"></div>
                                <ul class="child">
                                    ...
                                    <li><a href="/easygo2/easygo/index.php/Home/user/logout">退出登录</a></li>
                                </ul>
                            </div>
                        </li>
					</ul>
	...
	<div class="mybody">
       <div class="left">
       		<div class="person">
            	<div class="person_head">
                	<img src="/easygo2/easygo/Public/<?php echo ($user["user_head"]); ?>" class="head_img" width="113" height="113" alt="" />
                    <p><?php echo ($user['user_name']); ?><img src="/easygo2/easygo/Public/Home/images/card.gif" alt="" /></p>
                    <div class="left_1">
       ...
       <div class="right">
       		<div class="order yhk addyhk">
            	<h1>添加银行卡</h1>
                <table cellspacing="0">
                <form method="post" action="/easygo2/easygo/index.php/Home/Indent/addIt">
                	<tr>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="text" value="<?php echo ($data["user_telephone"]); ?>" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
...
<script src="/easygo2/easygo/Public/Home/js/jquery-1.11.0.min.js" type="text/javascript"></script>
