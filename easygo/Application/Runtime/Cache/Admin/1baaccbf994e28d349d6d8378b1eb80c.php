    ...
    <div class="row content">
        ...
        <div class="col-md-10 col-xs-10 right">
            ...
            <div class="buttongroup">
                <form action="<?php echo U('Cars/queryspecial');?>">
                	<a href="<?php echo U('Admin/Cars/add');?>" class="button1 button4">添加活动车辆</a>
                    日期：              
            ...
            <div class="tablegroup">
                <table class="table">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr data-toggle="modal" data-target="#mymodal-data" onclick="postIt(<?php echo ($d["inf_id"]); ?>)">
                          <td><?php echo ($d["inf_type"]); ?></td>
                          <td><?php echo ($d["inf_introduce"]); ?></td>
                          <td><?php echo ($d["inf_carnumber"]); ?></td>
                          <td><?php echo ($d["inf_specialdate"]); ?></td>
                          <td><?php echo ($d["user_name"]); ?></td>
                          <td><?php echo ($d["inf_city"]); ?></td>
                          <td>￥<?php echo ($d["inf_specialprice"]); ?>/天</td>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<button type="button" class="button1 button3" style="margin-right:20px;"><a id="del" href="">删除此车</a></button>
		...
		function postIt (res){	
			...
			function(data,status){	
				...
				console.log(array);
					...
					$("#detail p span").eq(3).text("￥"+array['inf_dayprice']+"/天");
					$("#detail p span").eq(4).text("￥"+array['inf_specialprice']+"/天");
					$("#del").attr('href',"/easygo/easygo/index.php/Admin/Cars/del/inf_id/"+array['inf_id']);
					var arr = array['inf_carphoto'].split(",");
					for(var i=0 ;i<arr.length-1;i++){	
						$('#detail p span').eq(5).append("<img style='margin:5px' src='/easygo/easygo/Public"+arr[i]+"' width='200' height='110' />")
					}
					return false;				
			});
