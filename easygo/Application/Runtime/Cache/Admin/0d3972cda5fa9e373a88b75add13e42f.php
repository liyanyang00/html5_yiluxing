						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body" style="overflow-y:auto;height:400px;" id="detail">
                                    ...
                                    <p>车辆信息：<span></span></p>
                                    <p>车辆原价：￥<span></span>/天</p>
                                    <p>活动价格：<span><input name="inf_specialprice" type="text" value=""></span>/天</p>
			...
			function(data,status){	
				...
				console.log(array);
					...
					for(var i=0 ;i<arr.length-1;i++){	
						$('#detail p span').eq(5).append("<img style='margin:5px' class='img' src='/easygo/easygo/Public"+arr[i]+"' width='200' height='110' />")
					}
