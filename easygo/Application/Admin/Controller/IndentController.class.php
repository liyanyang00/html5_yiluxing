...
class IndentController extends Controller {	
	...
	public function index(){	
		...
		$data = M("indent")->join('information on information.inf_id = indent.ind_inf_id','left')->join('usertab on usertab.user_id=information.inf_user_id','left')->select();
      ...
      $list = M("indent")->join('information on information.inf_id = indent.ind_inf_id','left')->join('usertab on usertab.user_id=information.inf_user_id','left')->order('ind_id desc')->limit($Page->firstRow.','.$Page->listRows)->select();
